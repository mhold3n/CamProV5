...
class ResultExporter {
     ...
     */
    private fun ensureJsonExtension(path: Path): Path {
        return if (FileIOUtils.getFileExtension(path) == "json") {
            path
        } else {
     ...
     */
    private fun ensureCsvExtension(path: Path): Path {
        return if (FileIOUtils.getFileExtension(path) == "csv") {
            path
        } else {
     ...
     */
    private fun ensurePdfExtension(path: Path): Path {
        return if (FileIOUtils.getFileExtension(path) == "pdf") {
            path
        } else {
     ...
     */
    private fun ensureExcelExtension(path: Path): Path {
        return if (FileIOUtils.getFileExtension(path) in listOf("xlsx", "xls")) {
            path
        } else {
