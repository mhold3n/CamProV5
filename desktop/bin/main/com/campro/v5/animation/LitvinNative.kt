 ...
 */
object LitvinNative {
    @JvmStatic external fun initRustLoggerNative(
        sessionId: String,
        level: String?,
        logDir: String?,
    )
    ...
    @JvmStatic external fun updateLitvinLawParametersNative(
        id: Long,
    ...
    @JvmStatic external fun getLitvinSystemStateNative(
        id: Long,
        alphaDeg: Double,
    ): String
    ...
    @JvmStatic external fun runDiagnosticsNative(
        id: Long,
        sessionId: String,
        paramHash: String?,
    ): String
