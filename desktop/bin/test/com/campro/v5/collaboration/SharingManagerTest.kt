...
class SharingManagerTest {
    ...
    @Test
    fun `test share project to cloud`() =
        runBlocking {
            val options =
                SharingOptions(
    ...
    @Test
    fun `test share project via email`() =
        runBlocking {
            val options =
                SharingOptions(
    ...
    @Test
    fun `test local network sharing`() =
        runBlocking {
            val result =
                sharingManager.shareProject(
                    testProjectData,
    ...
    @Test
    fun `test Git repository sharing`() =
        runBlocking {
            val options =
                SharingOptions(
    ...
    @Test
    fun `test share with unsupported platform`() =
        runBlocking {
            val result =
                sharingManager.shareProject(
                    testProjectData,
    ...
    @Test
    fun `test start collaboration session`() =
        runBlocking {
            val options =
    ...
    @Test
    fun `test collaboration session management`() =
        runBlocking {
            val result =
                sharingManager.startCollaboration(
                    testProjectData,
    ...
    @Test
    fun `test active shares tracking`() =
        runBlocking {
    ...
    @Test
    fun `test sharing progress tracking`() =
        runBlocking {
    ...
    @Test
    fun `test sharing with different access levels`() =
        runBlocking {
    ...
    @Test
    fun `test sharing with expiration date`() =
        runBlocking {
    ...
    @Test
    fun `test collaboration with different roles`() =
        runBlocking {
            val collaborators =
                listOf(
                    Collaborator(
    ...
    @Test
    fun `test collaboration session duration`() =
        runBlocking {
