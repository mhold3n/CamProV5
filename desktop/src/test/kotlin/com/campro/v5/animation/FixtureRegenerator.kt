...
class FixtureRegenerator {
    ...
    fun regenerate_motion_samples_small() {
        ...
        val params = LitvinUserParams(
            ...
            rampProfile = ((p["rampProfile"] as? String)?.let { runCatching { RampProfile.valueOf(it) }.getOrNull() }
        ...
        val header = mapOf(
            "generator" to mapOf(
                ...
                "created_utc" to (meta.created_utc ?: java.time.Instant.now().toString()),
                "params" to meta.params
            ),
            "stepDeg" to generated.stepDeg,
            "samples" to generated.samples.map { s ->
                mapOf(
