...
class OnboardingManagerTest {
    ...
    fun testStartingTutorial() = runBlocking {
        ...
        assertEquals("basic_mechanism", (receivedEvent as OnboardingEvent.TutorialStarted).tutorial.id, "Tutorial ID should be basic_mechanism")
    ...
    fun testCompletingTutorial() = runBlocking {
        ...
        assertEquals("basic_mechanism", (receivedEvent as OnboardingEvent.TutorialCompleted).tutorial.id, "Tutorial ID should be basic_mechanism")
    ...
    fun testLoadingSampleProject() = runBlocking {
        ...
        assertEquals("basic_mechanism", (receivedEvent as OnboardingEvent.SampleProjectLoaded).project.id, "Project ID should be basic_mechanism")
