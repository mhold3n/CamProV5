...
class ComparisonManagerTest {
    ...
    @Test
    fun `test compare project parameters`() =
        runBlocking {
            val result =
    ...
    @Test
    fun `test compare simulation results`() =
        runBlocking {
    ...
    @Test
    fun `test full project comparison`() =
        runBlocking {
            val result =
                comparisonManager.compareProjects(
                    project1,
    ...
    @Test
    fun `test compare projects with no simulation results`() =
        runBlocking {
    ...
    @Test
    fun `test compare with unsupported type`() =
        runBlocking {
            val result =
                comparisonManager.compareProjects(
                    project1,
    ...
    @Test
    fun `test comparison history tracking`() =
        runBlocking {
    ...
    @Test
    fun `test export comparison to JSON`() =
        runBlocking {
            val result =
                comparisonManager.compareProjects(
                    project1,
    ...
    @Test
    fun `test export comparison to HTML`() =
        runBlocking {
            val result =
                comparisonManager.compareProjects(
                    project1,
    ...
    @Test
    fun `test export comparison to CSV`() =
        runBlocking {
            val result =
                comparisonManager.compareProjects(
                    project1,
    ...
    @Test
    fun `test comparison with custom options`() =
        runBlocking {
            val options =
                ComparisonOptions(
    ...
    @Test
    fun `test performance comparison type`() =
        runBlocking {
            val result =
                comparisonManager.compareProjects(
                    project1,
    ...
    @Test
    fun `test visual comparison type`() =
        runBlocking {
            val result =
                comparisonManager.compareProjects(
                    project1,
    ...
    @Test
    fun `test comparison significance levels`() =
        runBlocking {
            val result =
                comparisonManager.compareProjects(
                    project1,
    ...
    @Test
    fun `test similarity score calculation`() =
        runBlocking {
    ...
    @Test
    fun `test comparison with missing parameters`() =
        runBlocking {
            // Reset state to ensure clean test
            comparisonManager.resetState()
    ...
    @Test
    fun `test comparison history limit`() =
        runBlocking {
    ...
    @Test
    fun `test export with invalid format`() =
        runBlocking {
            val result =
                comparisonManager.compareProjects(
                    project1,
    ...
    @Test
    fun `test export non-existent comparison`() =
        runBlocking {
            val exportPath = tempDir.resolve("comparison.json").toString()
