...
class SharingManagerTest {
    ...
    fun `test share project to cloud`() = runBlocking {
        ...
        val result = sharingManager.shareProject(
            testProjectData,
            "cloud",
            options
        )
    ...
    fun `test start collaboration session`() = runBlocking {
        val options = CollaborationOptions(
            permissions = mapOf(
        ...
        val result = sharingManager.startCollaboration(
            testProjectData,
            testCollaborators,
            options
        )
    ...
    fun `test collaboration session duration`() = runBlocking {
        ...
        val associatedShare = sharingManager.activeShares.value.find { 
