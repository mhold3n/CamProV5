...
class ExportManagerTest {
    ...
    @Test
    fun `test export simulation results`() =
        runBlocking {
    ...
    @Test
    fun `test export progress tracking`() =
        runBlocking {
            val exportPath = tempDir.resolve("test_export.json").toString()
    ...
    @Test
    fun `test export history tracking`() =
        runBlocking {
            val exportPath = tempDir.resolve("test_export.json").toString()
    ...
    @Test
    fun `test export history clearing`() =
        runBlocking {
            val exportPath = tempDir.resolve("test_export.json").toString()
    ...
    @Test
    fun `test export with custom options`() =
        runBlocking {
    ...
    @Test
    fun `test export to non-existent directory`() =
        runBlocking {
