...
class AnnotationManagerTest {
    ...
    @Test
    fun `test start annotation session`() =
        runBlocking {
            val session =
                annotationManager.startAnnotationSession(
    ...
    @Test
    fun `test end annotation session`() =
        runBlocking {
            assertTrue(annotationManager.isAnnotating())
    ...
    @Test
    fun `test add different annotation types`() =
        runBlocking {
    ...
    @Test
    fun `test add reply to annotation`() =
        runBlocking {
            val annotation =
                annotationManager.addAnnotation(
                    type = "question",
    ...
    @Test
    fun `test get annotations for project`() =
        runBlocking {
    ...
    @Test
    fun `test get annotations by type`() =
        runBlocking {
    ...
    @Test
    fun `test get annotations by status`() =
        runBlocking {
    ...
    @Test
    fun `test annotation statistics`() =
        runBlocking {
    ...
    @Test
    fun `test export annotations to JSON`() =
        runBlocking {
    ...
    @Test
    fun `test export annotations to CSV`() =
        runBlocking {
    ...
    @Test
    fun `test export annotations to HTML`() =
        runBlocking {
    ...
    @Test
    fun `test import annotations from JSON`() =
        runBlocking {
    ...
    @Test
    fun `test annotation with multiple replies`() =
        runBlocking {
            val annotation =
                annotationManager.addAnnotation(
                    type = "question",
    ...
    @Test
    fun `test annotation position tracking`() =
        runBlocking {
