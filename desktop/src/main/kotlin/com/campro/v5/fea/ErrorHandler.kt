...
class ErrorHandler {
    ...
    private fun registerDefaultRecoveryStrategies() {
        ...
        recoveryStrategies[ErrorType.LIBRARY_LOADING] = RecoveryStrategy(
        ...
        recoveryStrategies[ErrorType.COMPUTATION] = RecoveryStrategy(
        ...
        recoveryStrategies[ErrorType.DATA_TRANSFER] = RecoveryStrategy(
        ...
        recoveryStrategies[ErrorType.FILE_IO] = RecoveryStrategy(
        ...
        recoveryStrategies[ErrorType.OUT_OF_MEMORY] = RecoveryStrategy(
     ...
     */
    fun getAllErrors(): List<ErrorInfo> {
        return errorLog.values.toList()
    }
     ...
     */
    fun getErrorsByType(type: ErrorType): List<ErrorInfo> {
        return errorLog.values.filter { it.error.type == type }
    }
     ...
     */
    fun getRecoveryStrategy(type: ErrorType): RecoveryStrategy? {
     ...
     */
    fun hasRecoveryStrategy(type: ErrorType): Boolean {
        return recoveryStrategies.containsKey(type)
    }
}
...
data class DiagnosticReport(
    ...
    fun isSystemReady(): Boolean {
        return feaEngineAvailable && sufficientMemory
    }
