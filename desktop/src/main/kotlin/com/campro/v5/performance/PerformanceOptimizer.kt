...
object PerformanceOptimizer {
    ...
    fun isPerformanceAcceptable(): Boolean {
        ...
        return metrics.memoryUsage < 200 * 1024 * 1024 && // 200MB limit
 ...
 */
@Composable
fun OptimizedResultViewer(
    result: com.campro.v5.models.OptimizationResult,
 ...
 */
private fun processResultData(result: com.campro.v5.models.OptimizationResult): ProcessedResultData {
 ...
 */
private fun calculateSummaryStats(data: ProcessedResultData): SummaryStats {
    return SummaryStats(
 ...
 */
private data class ProcessedResultData(
