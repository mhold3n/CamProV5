...
fun FloatingPanelsLayout(
    ...
    val defaultPanelStates = mapOf(
        ...
        "animation" to FloatingPanelState(
            id = "animation",
            x = 20.dp,
            y = 380.dp,
            width = 500.dp,
    ...
    Column(
        ...
        val dynamicSplitRatio = when {
            animationSize != null && plotsSize != null -> {
                ...
                } else 0.6f // Animation gets more space by default
            }
